...
1. Start with the programmed movement and its intent.
2. Check equipment, readiness, time, and pain/symptom notes.
3. Choose the closest option that trains the same pattern with a similar fatigue cost.
4. Keep RPE and volume inside the plan for the day.
5. Log the substitution and the reason in the training log.
